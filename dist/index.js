...
var GridBody = function GridBody(_ref) {
  var tasks = _ref.tasks,
      ...
      weekendDay = _ref.weekendDay,
      weekendColor = _ref.weekendColor,
      holidayList = _ref.holidayList,
      holidayColor = _ref.holidayColor,
      rtl = _ref.rtl;
  var y = 0;
  var gridRows = [];
    ...
    if (holidayList && holidayList.length > 0) {
      for (var j = 0; j < holidayList.length; j++) {
        if (isSameDate(holidayList[j], date)) {
          holidays.push(React__default.createElement("rect", {
            key: "hl-" + currentTime,
            x: tickX,
            y: 0,
            width: columnWidth,
...
var Gantt = function Gantt(_ref) {
  var tasks = _ref.tasks,
      ...
      _ref$holidayList = _ref.holidayList,
      holidayList = _ref$holidayList === void 0 ? [] : _ref$holidayList,
      _ref$todayColor = _ref.todayColor,
      todayColor = _ref$todayColor === void 0 ? "rgba(252, 248, 227, 0.5)" : _ref$todayColor,
      _ref$holidayColor = _ref.holidayColor,
      holidayColor = _ref$holidayColor === void 0 ? "rgba(88, 255, 71, 0.2)" : _ref$holidayColor,
      _ref$weekendColor = _ref.weekendColor,
      weekendColor = _ref$weekendColor === void 0 ? "rgba(255, 99, 71, 0.2)" : _ref$weekendColor,
      _ref$weekendDay = _ref.weekendDay,
      weekendDay = _ref$weekendDay === void 0 ? [6, 0] : _ref$weekendDay,
      viewDate = _ref.viewDate,
      _ref$centerViewDate = _ref.centerViewDate,
      centerViewDate = _ref$centerViewDate === void 0 ? true : _ref$centerViewDate,
  ...
  React.useEffect(function () {
    if (viewMode === dateSetup.viewMode && (viewDate && !currentViewDate || viewDate && (currentViewDate === null || currentViewDate === void 0 ? void 0 : currentViewDate.valueOf()) !== viewDate.valueOf())) {
      ...
      if (centerViewDate) {
        var halfContainer = svgContainerWidth / 2;
        var halfColumn = columnWidth / 2;
